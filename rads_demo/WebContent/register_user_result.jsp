...
<%@ page
	import="cn.com.infosec.netcert.framework.resource.*,java.util.*,java.text.*,cn.com.infosec.netcert.rads61.*"%>
...
<%
	...
	Properties pro = manager.applyUser(p);
	String userID = pro.getProperty(PropertiesKeysRes.UUID);
